...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String[] args) {
        if (userRepository.count() == 0) {
            ...
            for (int i = 1; i <= 100; i++) {
                articles.add(new Article("첫 유저의 게시글 " + i, "59개 중요하다 안기어도 밝히어 버틴다 나타내어야 않아 16일 말하다. 한 잘 오지 담임도 제도 해치라 막 가지고 나쁘어요. 순박하던 의례가 너의 일일 도로 적다 단아하는가. 안정이 유권자 시간도 찍찍 되다. 거 남고 드리워진 강화하여야 장담하세요. 닮은 학년이, 허공이 오다 제외한, 하여. 발을 건의다 얻으면 많이 참고에 생기에서 발전의 8편 늘다. 뜀틀이 11대 구도에게 그 똑같다. 꺼진 버스다 분이 바르고 문무만 비판이 이달을 가옥으로, 나아가다 총각을 배포하다. \n" +
                        "\n" +
